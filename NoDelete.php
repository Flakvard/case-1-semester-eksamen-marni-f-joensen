<!DOCTYPE html>
<html lang="da-DK" class="no-js" amp="" transformed="self;v=1" i-amphtml-layout="" i-amphtml-no-boilerplate="">
...
<head>
    ...
    <meta property="og:title" content="Produkter - Farstrup Furniture">
    <meta property="og:url" content="https://farstrup.dk/produkter/">
    <meta property="og:site_name" content="Farstrup Furniture">
    <meta property="article:modified_time" content="2020-10-22T13:10:40+00:00">
    ...
    <style amp-custom="">
        ...
        *,
        ...
        amp-sidebar .menu .current_page_item a {
            border-bottom-color: #373635
        }

        amp-sidebar .menu .current_page_item a:after {
            border-color: transparent transparent transparent #373635
        }
        ...
        .post-type-archive .sidebar-enabled {
            flex-direction: column
        }
        ...
        .content>.products .woocommerce-loop-category__title {
            display: block;
            font-size: 24px;
            font-weight: lighter;
            padding-right: 30px
        ...
        .product-category a.product-content {
            text-decoration: none
        }
        ...
        body.post-type-archive .products .product-category amp-img>* {
            transition: transform 350ms ease-in-out
        }

        body.post-type-archive .products .product-category amp-img:hover>* {
            transform: scale(1.1)
        }

        body.post-type-archive .products .product-category .product-content {
            width: calc(100% - 30px);
            position: absolute;
            pointer-events: none;
            top: 40px;
        ...
        body.post-type-archive .products .product-category .product-content .woocommerce-loop-category__title {
            font-size: 24px
        }

        body.post-type-archive .products .product-category:nth-child(even) {
            align-self: flex-end
        }

        body.post-type-archive .products .product-category:nth-child(even) .product-content {
            left: auto;
            right: 20px;
            text-align: right
        }

        body.post-type-archive .products .product-category:last-child {
            margin-bottom: 0
        }
        ...
        body.post-type-archive .products .product-category.product {
            position: relative
        }

        body.post-type-archive .products .product-category.product .product-content.top_hojre {
            top: 0px;
            bottom: auto;
            right: 0px;
            left: auto;
        ...
        body.post-type-archive .products .product-category.product .product-content.bund_venstre {
            bottom: 0px;
            left: 0px;
            right: auto;
            top: auto;
        ...
        body.post-type-archive .products .product-category.product .product-content.bund_midt {
            bottom: 0px;
            left: 50%;
            right: auto;
            top: auto;
        ...
        body.post-type-archive .content>.products .woocommerce-loop-category__title {
            padding-right: 0px
        }
    ...
    <link rel="alternate" hreflang="da" href="https://farstrup.dk/produkter/">
    <link rel="alternate" hreflang="en" href="https://farstrup.dk/en/produkter/">
    <link rel="alternate" hreflang="nl" href="https://farstrup.dk/nl/produkter/">
    <link rel="alternate" hreflang="de" href="https://farstrup.dk/de/produkter/"><!-- This site is optimized with the Yoast SEO plugin v17.5 - https://yoast.com/wordpress/plugins/seo/ -->
    <link rel="canonical" href="https://farstrup.dk/produkter/">
    <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                ...
                "@type": "WebPage",
                "@id": "https://farstrup.dk/produkter/#webpage",
                "url": "https://farstrup.dk/produkter/",
                "name": "Produkter - Farstrup Furniture",
                "isPartOf": {
                    "@id": "https://farstrup.dk/#website"
                },
                "datePublished": "2020-07-07T15:15:37+00:00",
                "dateModified": "2020-10-22T13:10:40+00:00",
                "breadcrumb": {
                    "@id": "https://farstrup.dk/produkter/#breadcrumb"
                },
                "inLanguage": "da-DK",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["https://farstrup.dk/produkter/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "https://farstrup.dk/produkter/#breadcrumb",
    ...
    <link rel="alternate" type="application/rss+xml" title="Farstrup Furniture » Varer Feed" href="https://farstrup.dk/produkter/feed/">
...
<body data-rsssl="1" class="archive post-type-archive post-type-archive-product theme-oras woocommerce-shop woocommerce woocommerce-page woocommerce-no-js">
    <amp-analytics config="https://www.googletagmanager.com/amp.json?id=GTM-55G8TJ5&amp;gtm.url=SOURCE_URL" data-credentials="include" class="i-amphtml-layout-fixed i-amphtml-layout-size-defined" style="width:1px;height:1px" i-amphtml-layout="fixed"></amp-analytics>
            ...
            <div class="main-nav top-nav">
                <div class="menu-header-top-menu-container">
                    <ul id="menu-header-top-menu" class="menu">
                        <li id="menu-item-8992" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-8992"><a href="https://farstrup.dk/category/presse/">Presse</a></li>
            ...
            <div class="main-nav">
                <div class="menu-header-menu-container">
                    <ul id="menu-header-menu" class="menu">
                        <li id="menu-item-725" class="menu-kollektion menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children current-menu-item current_page_item menu-item-725"><a href="https://farstrup.dk/produkter/" aria-current="page">Kollektion</a>
                            <ul class="sub-menu">
                                <li id="menu-item-3830" class="menu-laenestole menu-item menu-item-type-custom menu-item-object-custom menu-item-3830"><a href="/vare-kategori/laenestole/">Lænestole</a></li>
                                <li id="menu-item-3829" class="menu-funktionsstole menu-item menu-item-type-custom menu-item-object-custom menu-item-3829"><a href="/vare-kategori/funktionsstole/">Funktionsstole</a></li>
                                <li id="menu-item-3832" class="menu-spisebordsstole menu-item menu-item-type-custom menu-item-object-custom menu-item-3832"><a href="/vare-kategori/spisebordsstole/">Spisebordsstole</a></li>
                                <li id="menu-item-3833" class="menu-stabelstole menu-item menu-item-type-custom menu-item-object-custom menu-item-3833"><a href="/vare-kategori/stabelstole/">Stabelstole</a></li>
                                <li id="menu-item-3831" class="menu-sofaer menu-item menu-item-type-custom menu-item-object-custom menu-item-3831"><a href="/vare-kategori/sofaer/">Sofaer</a></li>
                                <li id="menu-item-3828" class="menu-borde menu-item menu-item-type-custom menu-item-object-custom menu-item-3828"><a href="/vare-kategori/borde/">Borde</a></li>
                            </ul>
                        </li>
                        <li id="menu-item-721" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-721"><a href="https://farstrup.dk/forhandlere/">Forhandlere</a></li>
                        <li id="menu-item-722" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-722"><a href="https://farstrup.dk/om-os/">Om os</a></li>
                        <li id="menu-item-939" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-939"><a href="https://farstrup.dk/kontakt-os/">Kontakt</a></li>
                        ...
                        <li id="menu-item-wpml-ls-10-da" class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-da wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-has-children menu-item-wpml-ls-10-da"><a href="https://farstrup.dk/produkter/">
                            ...
                            <ul class="sub-menu">
                                <li id="menu-item-wpml-ls-10-en" class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-en wpml-ls-menu-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-10-en"><a href="https://farstrup.dk/en/produkter/">
                                ...
                                <li id="menu-item-wpml-ls-10-nl" class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-nl wpml-ls-menu-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-10-nl"><a href="https://farstrup.dk/nl/produkter/">
                                ...
                                <li id="menu-item-wpml-ls-10-de" class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-de wpml-ls-menu-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-10-de"><a href="https://farstrup.dk/de/produkter/">
    ...
    <div class="main-container ">
        ...
        <amp-sidebar id="mobilmenu" layout="nodisplay" side="right" class="i-amphtml-layout-nodisplay" hidden="hidden" i-amphtml-layout="nodisplay">
            ...
            <div class="menu-header-menu-container">
                <ul id="menu-header-menu-1" class="menu">
                    <li class="menu-kollektion menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children current-menu-item current_page_item menu-item-725"><a href="https://farstrup.dk/produkter/" aria-current="page">Kollektion</a>
                        <ul class="sub-menu">
                            ...
                            <li class="menu-sofaer menu-item menu-item-type-custom menu-item-object-custom menu-item-3831"><a href="/vare-kategori/sofaer/">Sofaer</a></li>
                    ...
                    <li class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-da wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-has-children menu-item-wpml-ls-10-da"><a href="https://farstrup.dk/produkter/">
                            <amp-img class="wpml-ls-flag amp-wp-enforced-sizes i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" src="https://farstrup.dk/wp-content/uploads/flags/da.png" alt="Dansk" width="45" height="30" layout="intrinsic" i-amphtml-layout="intrinsic">
                                <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjMwIiB3aWR0aD0iNDUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgdmVyc2lvbj0iMS4xIi8+"></i-amphtml-sizer><noscript><img src="https://farstrup.dk/wp-content/uploads/flags/da.png" alt="Dansk" width="45" height="30"></noscript>
                            </amp-img>
                        </a>
                        <ul class="sub-menu">
                            <li class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-en wpml-ls-menu-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-10-en"><a href="https://farstrup.dk/en/produkter/">
                                    <amp-img class="wpml-ls-flag amp-wp-enforced-sizes i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" src="https://farstrup.dk/wp-content/uploads/flags/en.png" alt="English" width="45" height="30" layout="intrinsic" i-amphtml-layout="intrinsic">
                                        <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjMwIiB3aWR0aD0iNDUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgdmVyc2lvbj0iMS4xIi8+"></i-amphtml-sizer><noscript><img src="https://farstrup.dk/wp-content/uploads/flags/en.png" alt="English" width="45" height="30"></noscript>
                                    </amp-img>
                                </a></li>
                            <li class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-nl wpml-ls-menu-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-10-nl"><a href="https://farstrup.dk/nl/produkter/">
                                    <amp-img class="wpml-ls-flag amp-wp-enforced-sizes i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" src="https://farstrup.dk/wp-content/uploads/flags/nl.png" alt="Dutch" width="45" height="30" layout="intrinsic" i-amphtml-layout="intrinsic">
                                        <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjMwIiB3aWR0aD0iNDUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgdmVyc2lvbj0iMS4xIi8+"></i-amphtml-sizer><noscript><img src="https://farstrup.dk/wp-content/uploads/flags/nl.png" alt="Dutch" width="45" height="30"></noscript>
                                    </amp-img>
                                </a></li>
                            <li class="menu-item wpml-ls-slot-10 wpml-ls-item wpml-ls-item-de wpml-ls-menu-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-10-de"><a href="https://farstrup.dk/de/produkter/">
                                    <amp-img class="wpml-ls-flag amp-wp-enforced-sizes i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" src="https://farstrup.dk/wp-content/uploads/flags/de.png" alt="German" width="45" height="30" layout="intrinsic" i-amphtml-layout="intrinsic">
                                        <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjMwIiB3aWR0aD0iNDUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgdmVyc2lvbj0iMS4xIi8+"></i-amphtml-sizer><noscript><img src="https://farstrup.dk/wp-content/uploads/flags/de.png" alt="German" width="45" height="30"></noscript>
                                    </amp-img>
                                </a></li>
        ...
        <div class="content-container shop sidebar-enabled sidebar-enabled-right">
            <div class="content">
                <header class="woocommerce-products-header">
                    <h1 class="woocommerce-products-header__title page-title large-lined-title">Produkter</h1>

                </header>
                <div class="woocommerce-notices-wrapper"></div>
                <div class="products columns-3">
                    <div class="product-category product first">
                        <a href="https://farstrup.dk/vare-kategori/laenestole/">
                            <amp-img layout="intrinsic" src="https://farstrup.dk/wp-content/uploads/Laenestole_360x440.jpg" alt="Lænestole" width="450" height="550" srcset="https://farstrup.dk/wp-content/uploads/Laenestole_360x440.jpg 360w, https://farstrup.dk/wp-content/uploads/Laenestole_360x440-245x300.jpg 245w" data-hero i-amphtml-ssr id="i-amp-0" class="i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" i-amphtml-layout="intrinsic">
                                <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjU1MCIgd2lkdGg9IjQ1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4="></i-amphtml-sizer><img class="i-amphtml-fill-content i-amphtml-replaced-content" decoding="async" loading="lazy" alt="Lænestole" src="https://farstrup.dk/wp-content/uploads/Laenestole_360x440.jpg" srcset="https://farstrup.dk/wp-content/uploads/Laenestole_360x440.jpg 360w, https://farstrup.dk/wp-content/uploads/Laenestole_360x440-245x300.jpg 245w" sizes="(max-width: 360px) 100vw, 360px">
                            </amp-img>
                        </a><a href="https://farstrup.dk/vare-kategori/laenestole/" class="product-content top_hojre">
                    ...
                    <div class="product-category product">
                        <a href="https://farstrup.dk/vare-kategori/funktionsstole/">
                            <amp-img layout="intrinsic" src="https://farstrup.dk/wp-content/uploads/Plus_5060_graa_compressed-450x550.jpg" alt="Funktionsstole" width="450" height="550" srcset="https://farstrup.dk/wp-content/uploads/Plus_5060_graa_compressed.jpg 450w, https://farstrup.dk/wp-content/uploads/Plus_5060_graa_compressed-245x300.jpg 245w" id="i-amp-1" class="i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" i-amphtml-layout="intrinsic">
                        ...
                        </a><a href="https://farstrup.dk/vare-kategori/funktionsstole/" class="product-content bund_venstre">
                            <p class="woocommerce-loop-category__title">
                                Funktionsstole </p>
                            <p class="woocommerce-loop-category__description">
                            </p>
                    ...
                    <div class="product-category product last">
                        <a href="https://farstrup.dk/vare-kategori/stabelstole/">
                            <amp-img layout="intrinsic" src="https://farstrup.dk/wp-content/uploads/Stabelsstole_400x400.jpg" alt="Stabelstole" width="450" height="550" srcset="https://farstrup.dk/wp-content/uploads/Stabelsstole_400x400.jpg 400w, https://farstrup.dk/wp-content/uploads/Stabelsstole_400x400-300x300.jpg 300w, https://farstrup.dk/wp-content/uploads/Stabelsstole_400x400-150x150.jpg 150w, https://farstrup.dk/wp-content/uploads/Stabelsstole_400x400-180x180.jpg 180w" id="i-amp-2" class="i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" i-amphtml-layout="intrinsic">
                                <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjU1MCIgd2lkdGg9IjQ1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4="></i-amphtml-sizer>
                            </amp-img>
                        </a><a href="https://farstrup.dk/vare-kategori/stabelstole/" class="product-content bund_venstre">
                            <p class="woocommerce-loop-category__title">
                                Stabelstole </p>
                            <p class="woocommerce-loop-category__description">
                            </p>
                    ...
                    <div class="product-category product first">
                        <a href="https://farstrup.dk/vare-kategori/spisebordsstole/">
                            <amp-img layout="intrinsic" src="https://farstrup.dk/wp-content/uploads/spisebordsstole_360x440.jpg" alt="Spisebordsstole" width="450" height="550" srcset="https://farstrup.dk/wp-content/uploads/spisebordsstole_360x440.jpg 360w, https://farstrup.dk/wp-content/uploads/spisebordsstole_360x440-245x300.jpg 245w" id="i-amp-3" class="i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" i-amphtml-layout="intrinsic">
                                <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjU1MCIgd2lkdGg9IjQ1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4="></i-amphtml-sizer>
                            </amp-img>
                        </a><a href="https://farstrup.dk/vare-kategori/spisebordsstole/" class="product-content bund_midt">
                            <p class="woocommerce-loop-category__title">
                                Spisebordsstole </p>
                            <p class="woocommerce-loop-category__description">
                            </p>
                    ...
                    <div class="product-category product">
                        <a href="https://farstrup.dk/vare-kategori/sofaer/">
                            <amp-img layout="intrinsic" src="https://farstrup.dk/wp-content/uploads/Scala_5413-450x550.jpg" alt="Sofaer" width="450" height="550" srcset="https://farstrup.dk/wp-content/uploads/Scala_5413.jpg 450w, https://farstrup.dk/wp-content/uploads/Scala_5413-245x300.jpg 245w" id="i-amp-4" class="i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" i-amphtml-layout="intrinsic">
                                <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjU1MCIgd2lkdGg9IjQ1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4="></i-amphtml-sizer>
                            </amp-img>
                        </a><a href="https://farstrup.dk/vare-kategori/sofaer/" class="product-content bund_venstre">
                            <p class="woocommerce-loop-category__title">
                                Sofaer </p>
                            <p class="woocommerce-loop-category__description">
                            </p>
                    ...
                    <div class="product-category product last">
                        <a href="https://farstrup.dk/vare-kategori/borde/">
                            <amp-img layout="intrinsic" src="https://farstrup.dk/wp-content/uploads/Borde_360x440.jpg" alt="Borde" width="450" height="550" srcset="https://farstrup.dk/wp-content/uploads/Borde_360x440.jpg 360w, https://farstrup.dk/wp-content/uploads/Borde_360x440-245x300.jpg 245w" id="i-amp-5" class="i-amphtml-layout-intrinsic i-amphtml-layout-size-defined" i-amphtml-layout="intrinsic">
                                <i-amphtml-sizer class="i-amphtml-sizer"><img alt="" aria-hidden="true" class="i-amphtml-intrinsic-sizer" role="presentation" src="data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjU1MCIgd2lkdGg9IjQ1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4="></i-amphtml-sizer>
                            </amp-img>
                        </a><a href="https://farstrup.dk/vare-kategori/borde/" class="product-content bund_midt">
                            <p class="woocommerce-loop-category__title">
                                Borde </p>
                            <p class="woocommerce-loop-category__description">
                            </p>
            ...
            <div class="sidebar sidebar-hojre">
...
const el = document.getElementById('callFormNotification');

//Hvis localStorage ikke har en status
if(!localStorage.getItem("status")){
    localStorage.setItem("status", "visible");
}

//Sæt klassen ud fra status
...
//Skift status når der trykkes på knapperne
const changeStatus = () => {
    if(localStorage.getItem("status") == 'hidden'){
...
//bind funktionen til knapperne.
toggleBtn.addEventListener('click', changeStatus);
closeBtn.addEventListener('click', changeStatus);</script>
...
Object Caching 521/1199 objects using disk

Served from: farstrup.dk @ 2021-12-03 19:57:25 by W3 Total Cache
-->